            ...
            <div class="col-full">
                <ul id="menu-top-bar-left" class="nav justify-content-center">
                    <li class="menu-item animate-dropdown">
                        <a title="TechMarket eCommerce - Always free delivery" href="contact-v1.html">MobileX &#8211;
                            Luôn Giao Hàng Miễn Phi</a>
                    </li>
                    <li class="menu-item animate-dropdown">
                        <a title="Quality Guarantee of products" href="shop.html">Đảm Bảo Chất Lượng</a>
                    </li>
                    <li class="menu-item animate-dropdown">
                        <a title="Fast returnings program" href="track-your-order.html">Chương Trình Hoàn Trả</a>
                    </li>
                    <li class="menu-item animate-dropdown">
                        <a title="No additional fees" href="contact-v2.html">Không Có Phí Bổ Sung</a>
                    </li>
                </ul>
                <!-- .nav -->
            </div>
                ...
                <div class="techmarket-sticky-wrap">
                    <div class="row">
                        <div class="site-branding">
                            ...
                            <img src="../assets/images/smart-phone-logo-design-mobile-logo-images-phone-x-logo-x-phone_526569-848.avif" alt="" width="150px" >
                            </a>
                            <!-- /.custom-logo-link -->
                        </div>
                        <!-- /.site-branding -->
                        ...
                        <nav id="primary-navigation" class="primary-navigation" aria-label="Primary Navigation"
                            data-nav="flex-menu" style="margin-top: 30px;">
                            <ul id="menu-primary-menu" class="nav yamm">
                                <li class="sale-clr yamm-fw menu-item animate-dropdown">
                                    <a title="Super deals" href="product-category.html">Siêu Ưu Đãi</a>
                                </li>
                                ...
                                <li class="yamm-fw menu-item menu-item-has-children animate-dropdown dropdown">
                                    <a title="Pages" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true"
                                        href="#">Sản Phẩm Hâng Đầu <span class="caret"></span></a>
                                    <ul role="menu" class=" dropdown-menu">
                                                ...
                                                <div class="tm-mega-menu">
                                                    <div class="widget widget_nav_menu">
                                                        ...
                                                        <li class="nav-title menu-item">
                                                                ...
                                                                <li class="menu-item">
                                                                    <a href="home-v1.html">SamSung</a>
                                                                </li>
                                                                <li class="menu-item">
                                                                    <a href="home-v2.html">Iphone</a>
                                                                </li>
                                                                <li class="menu-item">
                                                                    <a href="home-v3.html">Xiaomi</a>
                                                                </li>
                                                                <li class="menu-item">
                                                                    <a href="home-v4.html">Realme</a>
                                                                </li>
                                                                <li class="menu-item">
                                                                    <a href="home-v5.html">Nokia</a>
                                                                </li>
                            ...
                            <ul id="menu-secondary-menu" class="nav">
                                <li
                                    ...
                                    <a title="Track Your Order" href="track-your-order.html">
                                        <i class="tm tm-order-tracking"></i>Đơn Hàng Của Bạn</a>
                                </li>
                                
                                <li class="menu-item">
                                    <a title="My Account" href="login-and-register.html">
                                        <i class="tm tm-login-register"></i>Sign up or Sign in</a>
                                </li>
                                <li class="techmarket-flex-more-menu-item dropdown">
                                    <a title="..." href="#" data-toggle="dropdown" class="dropdown-toggle">...</a>
                                    <ul class="overflow-items dropdown-menu"></ul>
                        ...
                        <div id="departments-menu" class="dropdown departments-menu">
                            ...
                            <ul id="menu-departments-menu" class="dropdown-menu yamm departments-menu-dropdown">
                                ...
                                <li class="highlight menu-item animate-dropdown">
                                    <a title="Top 100 Offers" href="home-v3.html">Top 10 Ưu Đãi</a>
                                </li>
                               
                               
                               
                                <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown-submenu">
                                    <a title="Smart Phones &amp; Tablets" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true" href="#">Điện Thoại &#038; Máy Tính Bảng <span class="caret"></span></a>
                                    <ul role="menu" class=" dropdown-menu">
                                        <li class="menu-item menu-item-object-static_block animate-dropdown">
                                            <div class="yamm-content">
                                                    ...
                                                    <div class="col-md-6 col-sm-12">
                                                        <div class="kc-col-container">
                                                            <div class="kc_text_block">
                                                                <ul>
                                                                    <li class="nav-title">Điện Thoại </li>
                                ...
                                <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown-submenu">
                                    <a title="Accesories" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true" href="#">Phụ Kiện <span class="caret"></span></a>
                                    <ul role="menu" class=" dropdown-menu">
                                        <li class="menu-item menu-item-object-static_block animate-dropdown">
                                            <div class="yamm-content">
                                                <div class="bg-yamm-content bg-yamm-content-bottom bg-yamm-content-right">
                                                ...
                                                <div class="row yamm-content-row">
                                                    <div class="col-md-6 col-sm-12">
                                                        <div class="kc-col-container">
                                                            <div class="kc_text_block">
                                                                <ul>
                                                                    <li class="nav-title">Phụ Kiện </li>
                                                                    <li><a href="shop.html">Tất Cả  </a></li>
                                                                    <li><a href="shop.html">Cho SamSung</a></li>
                                                                    <li><a href="shop.html">Cho Iphone </a></li>
                                                                    <li><a href="shop.html">Cho Xiaomi </a></li>
                                                                    <li><a href="shop.html">Cho Realme </a></li>
                                                                    <li><a href="shop.html">Cho Nokia  </a></li>
                                                                    <li class="nav-divider"></li>
                                                                    <li>
                                                                        <a href="#">
                                                                            <span class="nav-text">Tất Cả Phụ Kiện Của Chúng Tôi</span>
                                                                            <span class="nav-subtext">Discover more products</span>
                                                                        </a>
                                                                    </li>
                                                                </ul>
                ...
                <div class="handheld-header">
                    ...
                    <div class="techmarket-sticky-wrap">
                        <div class="row">
                            ...
                            <!-- .site-search -->
                            <a class="handheld-header-cart-link has-icon" href="cart..php"
                                title="View your shopping cart">
                                <i class="tm tm-shopping-bag"></i>
                                <span class="count">2</span>
                            </a>
