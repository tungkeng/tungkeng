        ...
        <div id="primary" class="content-area">
          <main id="main" class="site-main">
            <div class="home-v1-slider home-slider">
              ...
              <!-- .slider-1 -->
              <div class="slider-1 slider-2" style="background-image: url(../assets/images/slider/bannerip1.jpg);">
                <!-- <img src="../assets/images/slider/home-v1-img-2.png" alt=""> -->
                <div class="caption" style="margin-top: 130px;">
                  <div class="title" style="font-size: 130%; font-style: italic;">Hiệu năng vượt trội Chip Apple A15 Bionic mạnh mẽ, hỗ trợ mạng 5G tốc độ cao
                    <br> Chip Apple A15 Bionic mạnh mẽ
                    <br> right here</div>
              ...
              <div class="features">
                <div class="feature">
                  <div class="media">
                    ...
                    <div class="media-body feature-text">
                      <h5 class="mt-0">Free Ship</h5>
                      <span>Đơn Hàng Trên 200k</span>
                ...
                <div class="feature">
                  <div class="media">
                    ...
                    <div class="media-body feature-text">
                      <h5 class="mt-0">99% Người Dùng</h5>
                      <span>Feedbacks</span>
                    </div>
                  </div>
                  <!-- .media -->
                ...
                <div class="feature">
                  <div class="media">
                    ...
                    <div class="media-body feature-text">
                      ...
                      <span>Nhanh Chóng - Trả Góp 0%</span>
                    </div>
                  </div>
                  <!-- .media -->
                </div>
                ...
                <div class="feature">
                  <div class="media">
                    ...
                    <div class="media-body feature-text">
                      <h5 class="mt-0">Giá Tốt Nhất</h5>
                      <span>Thương Hiệu Độc Quyền</span>
                    </div>
                  </div>
                  <!-- .media -->
                </div>
